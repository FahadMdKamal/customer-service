# Generated by Django 3.2.9 on 2022-01-17 12:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('allowed_channel_types', models.ManyToManyField(blank=True, help_text='Users with the channel types will be able to interact to', related_name='app_channel_set', related_query_name='app_channels', to='mavrik_apps.ChannelTypes', verbose_name='channels')),
            ],
            options={
